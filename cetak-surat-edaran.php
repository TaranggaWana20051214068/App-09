                                ...
                                <div class="border-t border-black mt-4 pt-4">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        <p class="mb-2 text-lg-right">Jakarta
                                            <?= ($row['tanggal']) ? $row['tanggal'] : date("d F Y"); ?>
                                        </p>
                                        <p class="mb-2">Nomor    :
                                            <?= $row['nomor_surat'] ?>
                                        </p>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="container">
                                            <p class="mb-4">Demikian yang dapat kami sampaikan, atas partisipasi Bapak/Ibu
                                                kami mengucapkan terimakasih.</p>
                                        </div>
