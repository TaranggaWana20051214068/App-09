                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Halaman Tidak Ditemukan
                                </h4>
                                <p>Your Request resulted in an error.</p>
                                <form class="mt-5 mb-5">

                                    <div class="text-center mb-4 mt-4"><a href="../index.php" class="btn btn-primary">Go
                                            to Homepage</a>
                                    </div>
                                </form>
                            </div>
