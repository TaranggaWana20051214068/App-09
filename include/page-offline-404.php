                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                <h1 class="error-text text-primary">Maaf</h1>
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Kamu Sedang Offline
                                </h4>
                                <p>Kamu Tidak Terhubung Internet.<br>
                                Periksa kembali Internetmu.</p>
                            </div>
                        </div>
                    </div>
                </div>
