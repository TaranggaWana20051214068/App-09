...
var cache_storage_name = "RT09-v1";
var start_page = ["https://www.farmacy.id/RT09/"];
var offline_page = "include/page-offline-404.php";
var first_cache_urls = [start_page, offline_page];
var never_cache_urls = [
  /\/dashboard-surat-rapat.php/,
  /\/t-surat-rapat.php/,
  /\/edit-surat-rapat.php/,
  /\/cetak-surat-rapat.php/,
  /\/dashboard-surat-edaran.php/,
  /\/t-surat-edaran.php/,
  /\/edit-surat-edaran.php/,
  /\/cetak-surat-edaran.php/,
];
      ...
      .then(function (response) {
        return (
          ...
          fetch(e.request).then(function (response) {
            return caches.open(cache_storage_name).then(function (cache) {
              if (
                never_cache_urls.every(check_never_cache_urls, e.request.url)
              ) {
                cache.put(e.request, response.clone());
              }
              return response;
